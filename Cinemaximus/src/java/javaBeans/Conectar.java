    ...
    public void criarBanco() {
        try {
            ...
            sql = "create table if not exists usuarios ( pkuser int AUTO_INCREMENT, "
                    + "nome varchar(40),email varchar(40), "
                    + "celular varchar(15), "
                    + "senha varchar(11), "
                    + "nivel varchar(20), "
                    + "foto varchar(20), primary key (pkuser) )";
            ps = con.prepareStatement(sql);
            ps.executeUpdate();

             sql = "create table if not exists ingressos ( pkId int AUTO_INCREMENT, "
                    + "filme varchar(40),email varchar(40), "
                    + "usuario varchar(15), "
                    + "valor double , "
                    + "data varchar(15), "
                    + "primary key (pkId) )";
